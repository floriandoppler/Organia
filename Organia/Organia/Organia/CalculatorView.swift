...
struct CalculatorView: View {
    ...
    var displayedString: String {
        String(format: "%.f", arguments: [state.currentNumber])
    }
...
struct NumberView: View {
    ...
    var body: some View {
        Text(numberString)
            ...
            .background(Color.organiaBlue)
            .cornerRadius(20)
            .shadow(color: Color.organiaBlue.opacity(0.3), radius: 10, x: 0, y: 10)
            .onTapGesture {
...
struct FunctionView: View {
    ...
    var body: some View {
        return Text(function.string())
            ...
            .frame(width: 64, height: 64)
            .background(Color.organiaGray.opacity(0.2))
        .cornerRadius(20)
            .shadow(color: Color.organiaGray.opacity(0.9), radius: 10, x: 0, y: 10)
            .onTapGesture {
...
struct ActionView: View {
    ...
    var body: some View {
        action.image()
            ...
            .foregroundColor(.white)
            .frame(width: 64, height: 64)
            .background(Color.organiaGreen)
            .cornerRadius(20)
            .shadow(color: Color.organiaGreen.opacity(0.3), radius: 10, x: 0, y: 10)
            .onTapGesture {
                self.tapped()
        }
    }
...
extension Color {
    static let organiaBlue = Color("Logo-Blue")
